...
$list1 = isset($_GET["list1_state"]) ? unserialize(urldecode($_GET["list1_state"])) : [1, 2, 3, 4];

$list2 = isset($_GET["list2_state"]) ? unserialize(urldecode($_GET["list2_state"])) : [5, 6];
...
$list1_state = urlencode(serialize($list1));
$list2_state = urlencode(serialize($list2));
...
<form>
    ...
    <input type="hidden" name="list1_state" value="<?= $list1_state ?>">
    <input type="hidden" name="list2_state" value="<?= $list2_state ?>">
